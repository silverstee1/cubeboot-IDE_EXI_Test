...
const char *dev_names[] = {"sda", "sdb", "sd2", "gcldr", "ataa", "atab", "atac"};
const DISC_INTERFACE *drivers[] = {&__io_gcsda, &__io_gcsdb, &__io_gcsd2, &__io_gcode, &__io_ataa, &__io_atab, &__io_atac};
